...
def main():
    ...
    parser.add_argument('--model', default='abmil', type=str, help='MIL model [dsmil]')
    ...
    milnet = abmil(input_size=args.feats_size).cuda()
    ...
    best_score = 10**(10)
    save_path = os.path.join('weights/abmil', datetime.datetime.now().strftime("%Y%m%d%H%M%S%f"))
    print(save_path)
